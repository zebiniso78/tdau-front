  ...
  return (
    <>
      <div className="row mt-5 align-items-end">
        <Title className="form-title">{t('english-test')}</Title>
        <div className="col-lg-3 col-sm-6 col-md-6 mt-3">
          <CheckboxWrapper>
            <Paragraph>{t('to-english')}</Paragraph>
            <CheckboxComponent
        ...
        <div className="col-lg-4 col-md-6 col-sm-6 mt-3">
          <UserFormSelectComponent
            ...
            control={control}
            required={true}
            title={t('next-test-english')}
            name="depar_id"
            placeholder={t('next-test-english')}
            disabled={false}
          />
        </div>
      ...
      <div className="row align-items-end mt-4">
        ...
        <div className="col-lg-4 col-md-6 col-sm-6 mt-3">
          <CheckboxWrapper>
            <Paragraph>
              Ваша полная степень бакалавра преподавалась на английском языке?*
            </Paragraph>
            <CheckboxComponent
              Controller={Controller}
              control={control}
