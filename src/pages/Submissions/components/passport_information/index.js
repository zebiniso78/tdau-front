...
export function PassportInformation() {
  ...
  return (
    <PassportInfoProvider>
      ...
      <ButtonsProvider>
        <CancelBtnComponent name='Назад' className='prev-btn' onClick={() => history.push("/academic-info")} />
        <NextBtnComponent name='Продолжить' className='next-btn' onClick={() => history.push("/address-info")} />
      </ButtonsProvider>
    </PassportInfoProvider>
  )
}
